 ...
 */
public class Tcp2flowNettyEventServerFactory extends NettyEventServerFactory {
     ...
     */
    public Tcp2flowNettyEventServerFactory(final Tcp2flowConfiguration tcp2flowconfiguration) {
        ...
        setHandlerSupplier(() -> Arrays.asList(
                    ...
                    new Tcp2flowDecoder(tcp2flowconfiguration.getLogger()),
                    new Tcp2flowReceiverHandler(tcp2flowconfiguration)
        ));
    }
}
