...
import static net.nerdfunk.nifi.common.AbstractPutFlow2NetProcessor.REL_FAILURE;
...
import net.nerdfunk.nifi.flow2udp.Flow2udpInitializer;
import org.apache.nifi.processor.Relationship;

@Tags({"put", "flow2udp", "tcp", "netty", "experimental"})
