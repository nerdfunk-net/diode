...
public class Tcp2flowDecoder extends ByteToMessageDecoder {
    ...
    protected State state = State.VERSION;
    ...
    public Tcp2flowDecoder(final ComponentLog logger) {
        super();
        this.initialState = State.VERSION;
     ...
     * 
     * @param context ChannelHandlerContext
     * @param cause What exception is caught
     * @throws Exception 
     */
    @Override
    ...
    private void sendMessage(byte[] bytes, List<Object> out) {
       Tcp2flowMessage tmsg = new Tcp2flowMessage(
                this.version,
                this.headerlength,
                this.payloadlength,
                this.header,
