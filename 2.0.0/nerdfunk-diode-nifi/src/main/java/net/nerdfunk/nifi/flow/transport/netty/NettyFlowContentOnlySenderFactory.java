 ...
 */
public class NettyFlowContentOnlySenderFactory extends NettyFlowSenderFactory<InputStream,FlowMessage> {
     ...
     */
    public NettyFlowContentOnlySenderFactory(final ComponentLog log, final String address, final int port) {
        super(address, port);
